-- Insertar los valores de los coches
insert into coches (ID, VIN, manufacturer, model, year, color) -- VIN, manufacturer, model, year, color
...
-- Insertar los valores de los clientes

insert into clientes (ID, CustomerID, Name, Phone, Email, Address, City, StateProvince, Country, Postal) 
...
-- Insertar los valores de los vendedores

insert into vendedor (ID, StaffID, Name, Store) 
...
-- Insertar los valores de Facturas 

insert into facturas (ID, InvoiceNumber, Date, Car, Customer, SalesPerson) 
